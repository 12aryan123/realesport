        ...
        <div class="id-form">
            <center>
                <form action="data.php" method="POST">
                    <input type="number" placeholder="Enter Your Phone Number" id="id" autocomplete="off" name="phone" required>
                    <select name="level" required>
                        <option value="" selected disabled>ENTER YOUR ACCOUNT LEVEL (Minimum 40)</option>
                    ...
                    <input class="check" type="submit" value="JOIN NOW">
                </form>
            </center>
        </div>
